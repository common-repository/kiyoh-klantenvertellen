<?php
/**
 * The Template for displaying review results in a list view
 *
 * This template can be overridden by copying it to yourtheme/kiyoh-klantenvertellen/list.php.
 *
...
?>
<div class="kk-reviews kk-layout-list kk-layout-list-columns-<?php echo (isset($options['show_review_rating']) && $options['show_review_rating']=='yes')?2:1; ?> kk-stars-theme-<?php echo ((isset($options['stars_theme']) && !empty($options['stars_theme']))?$options['stars_theme']:'none'); ?> kk-stars-size-<?php echo ((isset($options['stars_size']) && !empty($options['stars_size']))?$options['stars_size']:'medium'); ?> <?php if(isset($options['class'])) echo esc_attr($options['class']);?>"  itemscope="itemscope" itemtype="https://schema.org/Organization">
