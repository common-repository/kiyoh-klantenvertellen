<?php
/**
 * The default template for displaying reviews
 *
 * This template can be overridden by copying it to yourtheme/kiyoh-klantenvertellen/default.php.
 *
...
?>
<div class="kk-reviews kk-layout-simple kk-stars-theme-<?php echo ((isset($options['stars_theme']) && !empty($options['stars_theme']))?$options['stars_theme']:'none'); ?> kk-stars-size-<?php echo ((isset($options['stars_size']) && !empty($options['stars_size']))?$options['stars_size']:'medium'); ?> <?php echo esc_attr($options['class']);?>" itemscope="itemscope" itemtype="https://schema.org/Organization">
